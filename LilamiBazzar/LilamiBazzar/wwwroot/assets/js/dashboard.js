                        ...
                        datasets: [
                            {
                                ...
                                borderColor: gradientStrokeViolet, // Violet gradient
                                backgroundColor: 'rgba(154, 85, 255, 0.7)', // Semi-transparent Violet
                                hoverBackgroundColor: 'rgba(154, 85, 255, 1)', // Solid Violet on hover
                                pointRadius: 0,
                                fillColor: 'rgba(154, 85, 255, 0.7)',
                                fill: true,
                                borderWidth: 1,
                                data: data.map(item => item.ongoingCount),
                                barPercentage: 0.5,
                                categoryPercentage: 0.5,
                            },
                            {
                                label: "Completed Auctions",
                                borderColor: gradientStrokeBlue, // Blue gradient
                                backgroundColor: 'rgba(54, 215, 232, 0.7)', // Semi-transparent Blue
                                hoverBackgroundColor: 'rgba(54, 215, 232, 1)', // Solid Blue on hover
                                pointRadius: 0,
                                fillColor: 'rgba(54, 215, 232, 0.7)',
                                fill: true,
                                borderWidth: 1,
